...
test04()
{
  ...
  local snd_param="Edzfeofkoak"

  local cmd1="USER $USERNAME"
  local cmd2="PASS $PASS"
#   local cmd3="NOOP"
#   local cmd4="NOOP $snd_param"  
  local cmd0="QUIT"
...
#   launch_test "$test_name" "$cmd4" 500
  launch_test "$test_name" "$cmd0" 221
...
test05()
{
  ...
  local test_cmd="PWD"
  local wrong_cmd="NOTHING"

  local cmd1="USER $USERNAME"
  local cmd2="PASS $PASS"
  local cmd3="HELP"
#   local cmd4="HELP $test_cmd"
#   local cmd5="HELP $wrong_cmd"
  local cmd0="QUIT"
...
#   launch_test "$test_name" "$cmd5" 502
  launch_test "$test_name" "$cmd0" 221
